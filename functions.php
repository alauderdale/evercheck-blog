...
function boiler_scripts_styles() {
	...
	// wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/lib/jquery.js', '20120206', true );
	...
	wp_enqueue_script( 'viewchecker', get_template_directory_uri() . '/js/lib/jquery.viewportchecker.js', '20120206', true );

	wp_enqueue_script( 'menu', get_template_directory_uri() . '/js/lib/menu_button.js', '20120206', true );
